...
public class Worksheet2_Spring2025 {
	...
	public static void main(String[] args) {
		...
		IntegerQueueW2 queueNested = new IntegerQueueW2();
		
		//Adding Values 
		queueNested.offer(68);
		queueNested.offer(8);
		queueNested.offer(17);
		queueNested.offer(47);
		...
		//Size
		final int NESTED_QUEUE_SIZE = queueNested.size();
		
		//Displaying Values
		for(int i = 0; i < NESTED_QUEUE_SIZE; i++) {
			
			System.out.println("aNestedQueue[" + i + "] = " + queueNested.remove() );
