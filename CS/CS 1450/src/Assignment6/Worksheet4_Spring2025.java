...
public class Worksheet4_Spring2025 {
	...
	public static void main(String[] args) {
		...
		// ADD CODE HERE
		 ...
		 PriorityQueue<PlaneW4> runway = new PriorityQueue<>();
...
class PlaneW4 implements Comparable<PlaneW4> {	
	...
	@Override 
	public int compareTo(PlaneW4 otherPlane) {
		
		if(this.getContainersSize() > otherPlane.getContainersSize()) {
			
			return 1;
		}//If
		
		else if(this.getContainersSize() < otherPlane.getContainersSize()) {
