	...
	public static void main(String[] args) throws IOException {
		...
		for(int i = 0; i < animalClimberList.size(); i++) {
			...
			System.out.printf("%s \t\t%s\t\t%d\n", 
					animalClimberList.get(i).getName(), animalClimberList.get(i).getSpecies(), animalCasted.getClimbSpeed());
		...
		//Animal Name
		System.out.printf("%s the %s says %s!!!\n",animalObjArray[indexOfStrongestAnimal].getName(), animalObjArray[indexOfStrongestAnimal].getSpecies(),
		...
		if(animalObjArray[indexOfStrongestAnimal] instanceof Swimmer) {
			...
			Swimmer animalSwimmer = (Swimmer) (animalObjArray[indexOfStrongestAnimal]); //Casting Object To Get Interfaces For Animal Stats
		...
		if(animalObjArray[indexOfStrongestAnimal] instanceof Runner) {
			...
			Runner animalRunner = (Runner) (animalObjArray[indexOfStrongestAnimal]); //Casting Object To Get Interfaces For Animal Stats
		...
		if(animalObjArray[indexOfStrongestAnimal] instanceof Climber) {
			...
			Climber animalClimber = (Climber) (animalObjArray[indexOfStrongestAnimal]); //Casting Object To Get Interfaces For Animal Stats
...
public static void displayAnimal(Animal animal) {
	...
	if(animal instanceof Swimmer) {
		...
		Swimmer animalSwimmer = (Swimmer) (animal); //Casting Object To Get Interfaces For Animal Stats
	...
	if(animal instanceof Runner) {
		...
		Runner animalRunner = (Runner) (animal); //Casting Object To Get Interfaces For Animal Stats
	...
	if(animal instanceof Climber) {
		...
		Climber animalClimber = (Climber) (animal); //Casting Object To Get Interfaces For Animal Stats
		System.out.printf("Climbing Speed: %d\n", animalClimber.getClimbSpeed());
	}//If
